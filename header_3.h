 ...
 *
 *	The third set of tasks is manually calculated by Diqiu Zhou
 *	It is used to test for tasks in which the utility of each set of the tasks would add up to 85
 */
...
#define THREE_1_EXECUTION_TIME 19
#define THREE_2_EXECUTION_TIME 21
#define THREE_3_EXECUTION_TIME 22
#define THREE_4_EXECUTION_TIME 23
